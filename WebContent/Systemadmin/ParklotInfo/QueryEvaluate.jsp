...
<body>
	...
	<form class="form-inline"
		action="/Shared_Parking_Space/QueryEvaluateDao" method="post">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<div class="form-group">
			<select class="form-control col-xs-4" name="parklotname">
				<%
					DBBean db = new DBBean();
					String adminId = (String) session.getAttribute("userid");
					String selectSql = "select parklotName from table_parklotinfo";
					SysoUtils.print("查看所有停车场的sql：" + selectSql);
					ResultSet rs = db.executeQuery(selectSql);
					try {
						while (rs.next()) {
				%>
				<option class="form-control"
					value="<%=rs.getString("parklotName")%>">
					<%
						out.print(rs.getString("parklotName"));
					%>
				</option>
				<%
					}
		...
		<button type="submit" class="btn btn-success" id="btn_QueryEvaluate">查询</button>
