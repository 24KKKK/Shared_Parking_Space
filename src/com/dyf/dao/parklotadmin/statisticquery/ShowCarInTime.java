...
@WebServlet(description = "进入停车场车辆时段分布", urlPatterns = { "/ShowCarInTime" })
public class ShowCarInTime extends HttpServlet {

	private static final long serialVersionUID = -285423895958986665L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		SysoUtils.print("进入ShowCarInTime");
		...
		String selectSQL = "select SUBSTRING(indatetime,12,2) time,count(*) num from table_inoutinfo where parkadminid='"
				+ adminid + "' and SUBSTRING(indatetime,1,10)='" + parkDate + "' GROUP BY time asc";
